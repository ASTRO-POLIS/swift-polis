...
final class PolisArtifactTests: XCTestCase {
    ...
    func test_PolisArtifact_codingSupport_shouldSucceed() throws {
        // Given
        let sut = PolisArtifact(identity: TestingSupport.examplePolisIdentityBAO(), artifactType: .monument, visitingOpportunities: "One can visit Viktor Ambartsumian's monument et ant time BAO is open")
