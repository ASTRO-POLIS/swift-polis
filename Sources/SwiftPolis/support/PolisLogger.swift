...
public enum PolisLogger {
    ...
    ///  If the user of `PolisLogger` needs to set the login file path to another path, set `logFileURL` before calling the setup method
    @MainActor public static var logFileURL: URL? = URL(string: "file:///tmp/polis.log")
